...
System.register('nevware21.ts-utils', [], (function (exports) {
    ...
    return {
        execute: (function () {
            ...
            var isString = exports("isString", ( /*#__PURE__*/_createIs(STRING)));
            var isFunction = exports("isFunction", ( /*#__PURE__*/_createIs(FUNCTION)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var isDate = exports("isDate", ( /*#__PURE__*/_createObjIs("Date")));
            var isNumber = exports("isNumber", ( /*#__PURE__*/_createIs(NUMBER)));
            var isBoolean = exports("isBoolean", ( /*#__PURE__*/_createIs(BOOLEAN)));
            var isRegExp = exports("isRegExp", ( /*#__PURE__*/_createObjIs("RegExp")));
            var isFile = exports("isFile", ( /*#__PURE__*/_createObjIs("File")));
            var isFormData = exports("isFormData", ( /*#__PURE__*/_createObjIs("FormData")));
            var isBlob = exports("isBlob", ( /*#__PURE__*/_createObjIs("Blob")));
            var isArrayBuffer = exports("isArrayBuffer", ( /*#__PURE__*/_createObjIs("ArrayBuffer")));
            var isError = exports("isError", ( /*#__PURE__*/_createObjIs("Error")));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var strSlice = exports("strSlice", ( /*#__PURE__*/_unwrapFunction(SLICE, StrProto)));

            var strSubstring = exports("strSubstring", ( /*#__PURE__*/_unwrapFunction("substring", StrProto)));
            var strSubstr = exports("strSubstr", ( /*#__PURE__*/_unwrapFunctionWithPoly("substr", StrProto, polyStrSubstr)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var strStartsWith = exports("strStartsWith", ( /*#__PURE__*/_unwrapFunctionWithPoly("startsWith", StrProto, polyStrStartsWith)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var isSymbol = exports("isSymbol", ( /*#__PURE__*/_createIs("symbol")));
            /*#__NO_SIDE_EFFECTS__*/
            function hasSymbol() {
                return !!getSymbol();
            }
            ...
            var fnApply = exports("fnApply", ( /*#__PURE__*/_unwrapInstFunction("apply")));
            ...
            var arrEvery = exports("arrEvery", /*#__PURE__*/ _unwrapFunction("every", ArrProto));
            var arrFilter = exports("arrFilter", /*#__PURE__*/ _unwrapFunction("filter", ArrProto));
            ...
            var arrIndexOf = exports("arrIndexOf", ( /*#__PURE__*/_unwrapFunction(INDEX_OF, ArrProto)));
            var arrLastIndexOf = exports("arrLastIndexOf", ( /*#__PURE__*/_unwrapFunction(LAST_INDEX_OF, ArrProto)));

            var arrMap = exports("arrMap", ( /*#__PURE__*/_unwrapFunction("map", ArrProto)));

            var arrSlice = exports("arrSlice", ( /*#__PURE__*/_unwrapFunction(SLICE, ArrProto)));
            ...
            var arrFind = exports("arrFind", /*#__PURE__*/ _unwrapFunctionWithPoly("find", ArrProto, polyArrFind));
            var arrFindIndex = exports("arrFindIndex", /*#__PURE__*/ _unwrapFunctionWithPoly("findIndex", ArrProto, polyArrFindIndex));
            var arrFindLast = exports("arrFindLast", /*#__PURE__*/ _unwrapFunctionWithPoly("findLast", ArrProto, polyArrFindLast));
            var arrFindLastIndex = exports("arrFindLastIndex", /*#__PURE__*/ _unwrapFunctionWithPoly("findLastIndex", ArrProto, polyArrFindLastIndex));

            var arrFrom = exports("arrFrom", ArrCls.from || polyArrFrom);

            var arrIncludes = exports("arrIncludes", ( /*#__PURE__*/_unwrapFunctionWithPoly("includes", ArrProto, polyArrIncludes)));
            var arrContains = exports("arrContains", arrIncludes);

            var arrReduce = exports("arrReduce", ( /*#__PURE__*/_unwrapFunction("reduce", ArrProto)));

            var arrSome = exports("arrSome", ( /*#__PURE__*/_unwrapFunction("some", ArrProto)));

            var fnBind = exports("fnBind", ( /*#__PURE__*/_unwrapInstFunction("bind")));

            var fnCall = exports("fnCall", ( /*#__PURE__*/_unwrapInstFunction(CALL)));
            ...
            var objCreate = exports("objCreate", ObjClass["create"] || polyObjCreate);
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var polyStrTrim = exports("polyStrTrim", ( /*#__PURE__*/_createTrimFn(/^\s+|(?=\s)\s+$/g)));
            var polyStrTrimStart = exports("polyStrTrimStart", ( /*#__PURE__*/_createTrimFn(/^\s+/g)));
            var polyStrTrimEnd = exports("polyStrTrimEnd", ( /*#__PURE__*/_createTrimFn(/(?=\s)\s+$/g)));

            var strTrim = exports("strTrim", ( /*#__PURE__*/_unwrapFunctionWithPoly("trim", StrProto, polyStrTrim)));
            var strTrimStart = exports("strTrimStart", ( /*#__PURE__*/_unwrapFunctionWithPoly("trimStart", StrProto, polyStrTrimStart)));
            var strTrimLeft = exports("strTrimLeft", strTrimStart);
            var strTrimEnd = exports("strTrimEnd", ( /*#__PURE__*/_unwrapFunctionWithPoly("trimEnd", StrProto, polyStrTrimEnd)));
            var strTrimRight = exports("strTrimRight", strTrimEnd);

            var strUpper = exports("strUpper", ( /*#__PURE__*/_unwrapFunction("toUpperCase", StrProto)));
            var strLower = exports("strLower", ( /*#__PURE__*/_unwrapFunction("toLowerCase", StrProto)));
            ...
            var mathTrunc = exports("mathTrunc", MathCls.trunc || polyMathTrunc);
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var strRepeat = exports("strRepeat", ( /*#__PURE__*/_unwrapFunctionWithPoly("repeat", StrProto, polyStrRepeat)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var strPadStart = exports("strPadStart", ( /*#__PURE__*/_unwrapFunctionWithPoly("padStart", StrProto, polyStrPadStart)));
            var strPadEnd = exports("strPadEnd", ( /*#__PURE__*/_unwrapFunctionWithPoly("padEnd", StrProto, polyStrPadEnd)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var getLength = exports("getLength", ( /*#__PURE__*/_unwrapProp(LENGTH)));
            ...
            var strSplit = exports("strSplit", ( /*#__PURE__*/_unwrapFunction("split", StrProto)));
            var strSymSplit = exports("strSymSplit", ( /*#__PURE__*/_unwrapFunctionWithPoly("split", StrProto, !hasSymbol() ? polyStrSymSplit : null)));
            ...
            var strEndsWith = exports("strEndsWith", ( /*#__PURE__*/_unwrapFunctionWithPoly("endsWith", StrProto, polyStrEndsWith)));
            /*#__NO_SIDE_EFFECTS__*/
            ...
            var strIndexOf = exports("strIndexOf", ( /*#__PURE__*/_unwrapFunction(INDEX_OF, StrProto)));
            var strLastIndexOf = exports("strLastIndexOf", ( /*#__PURE__*/_unwrapFunction(LAST_INDEX_OF, StrProto)));

            var strIncludes = exports("strIncludes", ( /*#__PURE__*/_unwrapFunctionWithPoly("includes", StrProto, polyStrIncludes)));
